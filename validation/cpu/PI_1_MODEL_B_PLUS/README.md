...
|---|---|---|
| determinism, default backend (= portable on ARMv6) | `c0d933ea340452ec` (= golden) | 744 ms |
| determinism, `-DFP_MATH_FORCE_PORTABLE` | `c0d933ea340452ec` (= golden) | 745 ms |
| `--load model.mgw` inference, 20 samples | byte-identical to macOS host | 236 ms (~12 ms/name, ~500 tok/s) |
| full 5000-step training, stdout | byte-identical to macOS host | 594,650 ms (~0.12 s/step) |
